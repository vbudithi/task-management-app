       ...
       {user && (
            <div className="text-center">
              <p className="text-lg flex justify-end  ">
                  Welcome, 
                  <p className=" font-semibold text-orange-600 ">{capitalizeFirst(user.firstName)} {capitalizeFirst(user.lastName)} </p>
        ...
        <div className="text-4xl font-bold text-center -translate-y-15 ">Dashboard</div>
